resource "azurerm_public_ip" "my_public_ip" {
  name                = "${var.workload_nickname}LnxPublicIp"
...
resource "azurerm_network_security_group" "my_nsg" {
  name                = "${var.workload_nickname}LnxNsg"
  location            = var.resource_group.location
  resource_group_name = var.resource_group.name
...
resource "azurerm_virtual_network" "my_vnet" {
  name                = "${var.workload_nickname}LnxVnet"
...
resource "azurerm_subnet" "my_subnet" {
  name                 = "${var.workload_nickname}LnxSubnet"
  resource_group_name  = var.resource_group.name
...
resource "azurerm_network_interface" "my_nic" {
  name                = "${var.workload_nickname}LnxNic"
  location            = var.resource_group.location
  resource_group_name = var.resource_group.name

  ip_configuration {
    name                          = "${var.workload_nickname}Lnx_nic_configuration"
